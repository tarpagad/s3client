import { Cloud, LogIn, Shield, Zap } from "lucide-react";
				...
				<div className="max-w-4xl w-full text-center space-y-8">
					<div className="space-y-4">
						<h1 className="text-4xl md:text-6xl font-extrabold tracking-tighter leading-tight">
							Manage your S3 and R2 buckets{" "}
							<span className="text-primary">securely</span> and{" "}
							<span className="text-primary">efficiently</span>.
						</h1>
						<p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto">
							A premium web client for Amazon S3 and Cloudflare R2. Sign up to
							store credentials securely and manage all your buckets from one
							place.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 max-w-3xl mx-auto">
						<div className="flex flex-col items-center gap-3 p-6 rounded-xl border border-border/40 bg-card/50">
							...
							<p className="text-xs text-muted-foreground text-center">
								AES-256-GCM encryption for your cloud credentials.
							</p>
						</div>
						<div className="flex flex-col items-center gap-3 p-6 rounded-xl border border-border/40 bg-card/50">
							...
							<p className="text-xs text-muted-foreground text-center">
								Manage both Amazon S3 and Cloudflare R2 in one place.
							</p>
						</div>
						<div className="flex flex-col items-center gap-3 p-6 rounded-xl border border-border/40 bg-card/50">
							...
							<p className="text-xs text-muted-foreground text-center">
								Add and switch between multiple bucket connections.
							</p>
						</div>
					</div>
				</div>
